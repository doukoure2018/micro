                            ...
                            <li>
                                ...
                                <div class="hidden">
                                    ...
                                    <div class="p-3 text-center">
                                        <p-button [disabled]="!user?.pointventeId" label="Voir Toutes les demandes" class="p-button-link" [routerLink]="['/dashboards/credit/individuel/attente', user?.pointventeId]" />
                                    </div>
                                </div>
                            </li>
                        } @else {
...
export class AppTopbar {
    ...
    // Define the method as an arrow function to maintain 'this' context
    private loadDemandeAttente(): void {
        console.log('888888888');
        console.log(this.user?.pointventeId);
        if (!this.user?.pointventeId) return;
    ...
    ngOnChanges(changes: SimpleChanges): void {
        if (changes['user']?.currentValue?.pointventeId && changes['user'].currentValue !== changes['user'].previousValue) {
