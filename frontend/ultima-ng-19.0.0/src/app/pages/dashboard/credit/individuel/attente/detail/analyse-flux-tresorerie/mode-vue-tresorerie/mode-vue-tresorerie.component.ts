...
@Component({
    selector: 'app-mode-vue-tresorerie',
    imports: [CommonModule, TableModule, CardModule, TagModule],
    templateUrl: './mode-vue-tresorerie.component.html',
    styleUrl: './mode-vue-tresorerie.component.scss'
})
export class ModeVueTresorerieComponent {
    @Input() tresorerieForm!: FormGroup;
    @Input() creditParams: any;

    // IMPORTANT : Inclure le mois 0 dans la vue d'ensemble
    mois = Array.from({ length: 13 }, (_, i) => i); // 0 à 12 au lieu de 1 à 12
