import{c as g}from"./chunk-BODZH67C.js";import{d as pe}from"./chunk-ULM4QL4Q.js";import{Aa as le,D as I,Da as ce,L as oe,N as ne,b as J,i as ee,m as te,pa as re,sa as se,t as ie,ta as y,xa as ae}from"./chunk-3YZBLOIS.js";import{c as G,d as L,f as v,g as b,h as O}from"./chunk-S35HUXPS.js";import{A as m,l as W,n as q,q as K,r as U,y as X}from"./chunk-GZWLZB4Q.js";import{Gb as w,Hb as Z,Kc as f,Lc as Y,Mb as B,Rb as u,Sb as r,Tb as M,U as P,Ua as $,Ub as j,V as D,Va as H,Xb as k,Zb as T,_ as p,_b as S,fa as l,ga as c,gb as z,hb as E,ja as C,kb as A,lc as N,mb as d,nc as Q,oc as x,pa as _,qa as V,ub as F,vb as h,zb as R}from"./chunk-MKA3N2SS.js";var he=["content"],ue=["*"],fe=(t,s)=>({showTransitionParams:t,hideTransitionParams:s}),me=(t,s)=>({value:t,params:s}),ve=t=>({closeCallback:t});function be(t,s){}function ye(t,s){t&1&&d(0,be,0,0,"ng-template")}function ge(t,s){if(t&1){let e=B();w(0,"div",1),u("click",function(o){l(e);let n=r();return c(n.onOverlayClick(o))})("@animation.start",function(o){l(e);let n=r();return c(n.onAnimationStart(o))})("@animation.done",function(o){l(e);let n=r();return c(n.onAnimationEnd(o))}),w(1,"div",2),u("click",function(o){l(e);let n=r();return c(n.onContentClick(o))})("mousedown",function(o){l(e);let n=r();return c(n.onContentClick(o))}),j(2),d(3,ye,1,0,null,3),Z()()}if(t&2){let e=r();R(e.styleClass),h("ngClass","p-popover p-component")("ngStyle",e.style)("@animation",x(13,me,e.overlayVisible?"open":"close",x(10,fe,e.showTransitionOptions,e.hideTransitionOptions))),F("aria-modal",e.overlayVisible)("aria-label",e.ariaLabel)("aria-labelledBy",e.ariaLabelledBy),H(3),h("ngTemplateOutlet",e.contentTemplate||e._contentTemplate)("ngTemplateOutletContext",Q(16,ve,e.onCloseClick.bind(e)))}}var Ce=({dt:t})=>`
.p-popover {
