...
// src/app/pages/service/type.credit.service.ts
var TypeCreditService = class _TypeCreditService {
  creditTypes = [
  ...
  getCreditTypeDescription(tipCredito) {
    if (!tipCredito) {
      return "Type de cr\xE9dit non d\xE9fini";
    }
    const creditType = this.getCreditTypeById(tipCredito);
    return creditType ? creditType.des_TIP_CREDITO : `Type de cr\xE9dit ${tipCredito}`;
  }
  /**
   ...
   */
  getCreditTypesByCategory(category) {
   ...
   */
  getTotalCreditTypesCount() {
    return this.creditTypes.length;
  }
  static \u0275fac = function TypeCreditService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _TypeCreditService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _TypeCreditService, factory: _TypeCreditService.\u0275fac, providedIn: "root" });
};

export {
  TypeCreditService
};
//# sourceMappingURL=chunk-YHWPLZ6H.js.map
