...
END IF;
    ...
    -- ========================================
    -- 10. CONSTRUCTION DU JSON DE RÉSUMÉ (MODIFIÉ AVEC UTILISATEUR)
    -- ========================================
...
COMMENT ON FUNCTION public.obtenir_resume_analyse_credit(integer)
    IS 'Fonction pour obtenir un résumé d''analyse de crédit avec calculs de ratios de dépendance aux autres revenus et informations utilisateur';