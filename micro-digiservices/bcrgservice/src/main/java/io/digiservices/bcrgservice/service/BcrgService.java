...
public interface BcrgService {
    ...
    PageDto<PersonnePhysiqueDto> getPersonnesPhysiques(int page, int size);

    PersonnePhysiqueDto getPersonnePhysique(String idClient);

    PageDto<PersonneMoraleDto> getPersonnesMorales(int page, int size);

    PersonneMoraleDto getPersonneMorale(String idClient);

    PageDto<EngagementDto> getEngagements(int page, int size);
