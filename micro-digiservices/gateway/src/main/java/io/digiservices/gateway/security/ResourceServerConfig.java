...
public class ResourceServerConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests( authorize -> authorize
                        .requestMatchers("/actuator/health","/actuator/info","/user/register/**", "/user/verify/account/**","/user/verify/password/**", "/user/resetpassword/**", "/user/image/**","/ebanking/search/**","/ebanking/typeCredit/**","/ecredit/addDemandeInd/**","/ecredit/docs/**","/ecredit/files/**","user/getUser/**","/ecredit/search/**","/ecredit/newDemandeInd/**","/ecredit/edg/**","/ecredit/public/**","/agents/**").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource()
    {
        ...
        corsConfiguration.setAllowedOrigins(List.of( "http://localhost:3000","http://localhost:4200","http://51.91.254.218:4200","http://51.91.254.218", "http://digi-creditrural-io.com",
