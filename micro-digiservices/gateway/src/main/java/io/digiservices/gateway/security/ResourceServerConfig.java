    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests( authorize -> authorize
                        .requestMatchers("/actuator/health","/actuator/info","/user/register/**", "/user/verify/account/**","/user/verify/password/**", "/user/resetpassword/**", "/user/image/**","/ebanking/search/**","/ebanking/typeCredit/**","/ecredit/addDemandeInd/**","/ecredit/docs/**","user/getUser/**","/ecredit/search/**","/ecredit/newDemandeInd/**","/ecredit/edg/**","/ecredit/public/**","/agents/**").permitAll()
