package io.digiservices.notificationservice.security;


import io.digiservices.notificationservice.handler.CustomAccessDeniedHandler;
import io.digiservices.notificationservice.handler.CustomAuthenticationEntryPoint;
...
public class ResourceServerConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.setAllowedOrigins(List.of("http://securedoc.com", "http://192.168.1.159:3000", "http://localhost:4200","http://localhost:4200", "100.14.214.212:3000",  "http://96.255.228.129:3000", "http://localhost:4200","http://localhost:4200", "http://localhost:3000", "http://securecapita.org", "http://192.168.1.216:3000",
                "http://digi-creditrural-io.com","https://digi-creditrural-io.com","http://www.digi-creditrural-io.com","https://www.digi-creditrural-io.com"));
